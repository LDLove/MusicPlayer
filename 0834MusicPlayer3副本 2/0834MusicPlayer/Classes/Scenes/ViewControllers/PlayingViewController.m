...
//    [self.btn4PlayOrPause setTitle:@"暂停" forState:UIControlStateNormal];
    [self.btn4PlayOrPause setBackgroundImage:[UIImage imageNamed:@"4"] forState:UIControlStateNormal];
...
- (IBAction)action4PlayOrPause:(UIButton *)sender {
    ...
    if ([PlayerManager sharedManager].isPlaying) {
        ...
        [sender setBackgroundImage:[UIImage imageNamed:@"3.png"] forState:UIControlStateNormal];
